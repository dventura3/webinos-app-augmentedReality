...
qrcode.decode = function(src){
	...
	if(arguments.length==0)
	{
		...
		var canvas_qr = document.getElementById("photo");
		var context = canvas_qr.getContext('2d');
		qrcode.width = canvas_qr.width;
		qrcode.height = canvas_qr.height;
		qrcode.imagedata = context.getImageData(0, 0, 640, 480);
	...
	else
	{
		...
		image.onload=function(){
			...
			if(canvas_out!=null)
			{
				...
				console.log("out canvas drawed");
			}
			console.log("start getting dim");
